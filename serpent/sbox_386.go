...
// This version, tries to minimize the number
// of registers (x86).
...
// optimisation. The functions use the Serpent S-Box improvements for x86
// from Dag Arne Osvik described in http://www.ii.uib.no/~osvik/pub/aes3.pdf.
