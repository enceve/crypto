...
func toHex(t *testing.T, s string) []byte {
...
var vectors = []testVector{
	...
	testVector{
		p:   &Params{HashSize: StateSize256, BlockSize: StateSize256},
		in:  "FF",
		ref: "0B98DCD198EA0E50A7A244C444E25C23DA30C10FC9A1F270A6637F1F34E67ED2",
	},
	testVector{
		p:   &Params{HashSize: StateSize256, BlockSize: StateSize256},
		in:  "FFFEFDFCFBFAF9F8F7F6F5F4F3F2F1F0EFEEEDECEBEAE9E8E7E6E5E4E3E2E1E0",
		ref: "8D0FA4EF777FD759DFD4044E6F6A5AC3C774AEC943DCFC07927B723B5DBF408B",
	},
	...
	testVector{
		...
		in: "",
		ref: "9BD43D2A2FCFA92BECB9F69FAAB3936978F1B865B7E44338FC9C8F16ABA949BA" +
			"340291082834A1FC5AA81649E13D50CD98641A1D0883062BFE2C16D1FAA7E3AA",
	},
	testVector{
		p:  &Params{HashSize: StateSize512, BlockSize: StateSize512},
		in: "FF",
		ref: "71B7BCE6FE6452227B9CED6014249E5BF9A9754C3AD618CCC4E0AAE16B316CC8" +
	...
	testVector{
		...
		ref: "45863BA3BE0C4DFC27E75D358496F4AC9A736A505D9313B42B2F5EADA79FC17F" +
	...
	testVector{
		...
		in: "",
		ref: "BCF37B3459C88959D6B6B58B2BFE142CEF60C6F4EC56B0702480D7893A2B0595" +
	...
	testVector{
		p:  &Params{HashSize: StateSize1024, BlockSize: StateSize1024},
		in: "FF",
		ref: "E62C05802EA0152407CDD8787FDA9E35703DE862A4FBC119CFF8590AFE79250B" +
	...
	testVector{
		...
		ref: "1F3E02C46FB80A3FCD2DFBBC7C173800B40C60C2354AF551189EBF433C3D85F9" +
...
func TestSkein(t *testing.T) {
	for i, v := range vectors {
		p, in, ref := v.p, toHex(t, v.in), toHex(t, v.ref)
